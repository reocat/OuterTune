...
class LocalMediaScanner {
    ...
    companion object {
        ...
        fun compareSong(
             ...
             */
            fun closeEnough(): Boolean = a.song.localPath == b.song.localPath
